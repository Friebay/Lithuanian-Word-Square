...
def insert_words_from_file():
    """Insert words from lithuanian-words-list.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'lithuanian-words-list.txt')
    ...
    try:
        ...
        source_name = "lithuanian-words-txt"
        source_description = "https://github.com/giekaton/lithuanian-words-txt"
        ...
        with open(txt_file_path, 'r', encoding='utf-8') as file:
            for line_num, line in enumerate(file, 1):
                ...
                batch_words.append((
                    ...
                    word_length,             # length
                    source_name,             # source
                    'lithuanian-words-list.txt', # source_file
                    word,                    # original_form
