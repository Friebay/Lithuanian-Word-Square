...
def insert_words_from_file():
    """Insert words from lt-LT_cleaned.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'lt-LT_cleaned.txt')
    ...
    try:
        ...
        source_name = "lt-LT_cleaned"
        source_description = "https://github.com/Semantika2/Lietuviu-kalbos-rasybos-tikrintuvai-bei-Hunspell-zodynai-gramatika"
