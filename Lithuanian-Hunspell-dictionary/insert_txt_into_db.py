...
def insert_words_from_file():
    """Insert words from lt-LT_plus_substandard_cleaned.txt into the words database."""
    ...
    try:
        ...
        source_name = "lt-LT_plus_substandard_cleaned_2"
        source_description = "https://clarin.vdu.lt/xmlui/handle/20.500.11821/64"
        ...
        with open(txt_file_path, 'r', encoding='utf-8') as file:
            for line_num, line in enumerate(file, 1):
                ...
                batch_words.append((
                    ...
                    word_length,             # length
                    source_name,             # source
                    'lt-LT_plus_substandard_cleaned.txt', # source_file
                    word,                    # original_form
