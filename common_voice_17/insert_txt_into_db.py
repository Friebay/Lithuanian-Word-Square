...
def insert_words_from_file():
    """Insert words from words_cleaned.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'words_cleaned.txt')
    ...
    try:
        ...
        source_name = "common_voice_17"
        source_description = "https://huggingface.co/datasets/mozilla-foundation/common_voice_17_0/tree/main/transcript/lt"
