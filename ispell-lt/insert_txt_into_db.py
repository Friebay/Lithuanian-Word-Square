...
def insert_words_from_file():
    """Insert words from lietuviu_combined.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'lietuviu_combined.txt')
    ...
    try:
        ...
        source_name = "lietuviu_combined"
        source_description = "Combined Lithuanian words from ispell-lt"
        ...
        with open(txt_file_path, 'r', encoding='utf-8') as file:
            for line_num, line in enumerate(file, 1):
                ...
                batch_words.append((
                    ...
                    word_length,             # length
                    source_name,             # source
                    'lietuviu_combined.txt', # source_file
                    word,                    # original_form
