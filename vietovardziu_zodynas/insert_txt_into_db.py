...
def insert_words_from_file():
    """Insert words from VietovardziuZodynas_cleaned.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'VietovardziuZodynas_cleaned.txt')
        ...
        with open(txt_file_path, 'r', encoding='utf-8') as file:
            for line_num, line in enumerate(file, 1):
                ...
                batch_words.append((
                    ...
                    word_length,             # length
                    source_name,             # source
                    'VietovardziuZodynas_cleaned.txt', # source_file
                    word,                    # original_form
