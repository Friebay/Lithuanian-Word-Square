...
def insert_words_from_file():
    """Insert words from wiki_cleaned.txt into the words database."""
    
    # Get paths
    script_dir = os.path.dirname(os.path.abspath(__file__))
    txt_file_path = os.path.join(script_dir, 'wiki_cleaned.txt')
    ...
    try:
        ...
        source_description = "https://dumps.wikimedia.org/ltwiki/20250701/"
